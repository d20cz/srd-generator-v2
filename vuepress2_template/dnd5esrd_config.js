...
let books = [
    {
        ...
        children: [
            ...
            {
                text: 'Volův průvodce netvory',
                link: '/voluv-pruvodce-netvory/1-kapitola',
                activeMatch: '/voluv-pruvodce-netvory/',
            },
        ],
    },
    {
...
let grimoars = [
    ...
    {
        text: 'Grimoar povolání',
        link: '/grimoar/grimoar-povolani',
        activeMatch: '/grimoar/grimoar-povolani',
    },
];
let sumaryClasses = [
    {
...
let config = {
    ...
    sidebar: {
        ...
        '/voluv-pruvodce-netvory/': [
            tools.expandBook('Volův průvodce netvory', 'voluv-pruvodce-netvory', [
                '1-kapitola',
                '2-kapitola',
                '3-kapitola',
                'Bandrhob',
